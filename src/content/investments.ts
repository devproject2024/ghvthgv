/**
 * COMPATIBILITY SHIM
 * The portfolio data now lives in `markets-portfolio.ts` (holdings +
 * overview metrics). This file simply re-exports it so older imports
 * keep working. Edit the data in `markets-portfolio.ts`.
 */
