      ...
      <Container>
        <Reveal className="grid grid-cols-12 gap-x-6 gap-y-8">
          ...
          <div className="col-span-12 lg:col-span-9">
            <h1 className="text-h1 max-w-[18ch] text-ink">{profile.contactStatement}</h1>
            {profile.availability && <p className="text-lead mt-6 max-w-[46ch] text-ink-2">{profile.availability}</p>}
          </div>
        </Reveal>
